...
def actividad_interactiva():
    ...
    nombre_archivo = input(
        "Ingresa el nombre del archivo que deseas leer (incluye la extensión): "
    )
    try:
        ...
        print(
            f"El archivo '{nombre_archivo}' no se encontró. Por favor, verifica el nombre e inténtalo de nuevo."
        )
